        ...
        <%@page contentType="text/html" pageEncoding="UTF-8" %>
            ...
            <head>
                ...
                <style>
                    ...
                    .kiddy-toast {
                        ...
                        border-radius: 18px;
                        box-shadow: 0 10px 28px rgba(236, 64, 122, 0.25);
                        background: #fff;
                    ...
                    .kiddy-toast__close:hover {
                        color: #EC407A;
                    }

                    .kiddy-toast__progress {
                        height: 5px;
                        background: #FCE4EC;
                        border-radius: 20px;
                        overflow: hidden;
                    ...
                    .kiddy-toast__progress span {
                        display: block;
                        height: 100%;
                        width: 100%;
                        background: linear-gradient(90deg, #F06292, #EC407A);
                        transform-origin: left;
                        animation: kiddyToastProgress 3.2s linear forwards;
                    }

                    @keyframes kiddyToastProgress {
                        from {
                            transform: scaleX(1);
                        }
                    ...
                    .kiddy-toast--success .kiddy-toast__icon {
                        background: linear-gradient(135deg, #66bb6a, #43a047);
                        color: #fff;
                    }

                    .kiddy-toast--success .kiddy-toast__title {
                        color: #2e7d32;
                    }
                    ...
                    .kiddy-toast--error .kiddy-toast__icon {
                        background: linear-gradient(135deg, #e53935, #b71c1c);
                        color: #fff;
                    }

                    .kiddy-toast--error .kiddy-toast__title {
                        color: #b71c1c;
                    }
            ...
            <body>
                        ...
                        <div class="col-sm-9">
                            ...
                            <div id="productArea">
                                ...
                                <div class="d-flex align-items-center mb-3" style="gap:10px;">
                                    ...
                                    <a href="home" class="btn btn-outline-light" style="border:1px solid #eee;">Tùy
                                        chọn</a>
                                    ...
                                    <a href="${popularUrl}" class="btn"
                                        style="background:#EC407A;color:white;font-weight:700;">Phổ Biến</a>
                                    ...
                                    <a href="${priceAscUrl}" class="btn"
                                        style="background:#fff;border:1px solid #FCE4EC;color:#C2185B;font-weight:700;">Giá
                                        ↑</a>
                                        ...
                                        <div class="col-12 col-md-6 col-lg-4 mb-4">
                                            <div class="card product-card">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col">
                                                            <p class="btn btn-price btn-block">
                                                        ...
                                                        <div class="col">
                                                            <a href="detail?pid=${o.id}"
                                                                class="btn btn-kid-cart btn-block">Add to cart</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <ul class="pagination justify-content-center kid-pagination">
                                                ...
                                                <c:forEach var="i" begin="1" end="${totalPage}">
                                                    ...
                                                    <li class="page-item ${i == page ? 'active' : ''}"><a
                                                            class="page-link" href="${pageUrl}">${i}</a></li>
                                                </c:forEach>
                ...
                <div id="kiddyToast" class="kiddy-toast" role="alert" aria-live="polite" aria-atomic="true">
                    ...
                    <button type="button" class="kiddy-toast__close" id="kiddyToastClose"
                ...
                <script>
                    ...
                    function showToast(message, type) {
                        ...
                        // Auto hide
                        clearTimeout(window.__kiddyToastTimer);
                        window.__kiddyToastTimer = setTimeout(function () { hideToast(); }, 3200);
                    }
                    function hideToast() {
                        var toast = document.getElementById('kiddyToast');
                        if (!toast) return;
                ...
                <c:if test="${sessionScope.requirePasswordChange == true}">
                    <div class="modal fade show" id="changePasswordModal" tabindex="-1" role="dialog"
                        style="display: block; background-color: rgba(0,0,0,0.5);" data-backdrop="static"
                        data-keyboard="false">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content"
                                style="border-radius: 15px; border: none; box-shadow: 0 10px 30px rgba(0,0,0,0.3);">
                                <div class="modal-header"
                                    style="background: linear-gradient(135deg, #a366d1 0%, #9b59b6 100%); color: white; border-radius: 15px 15px 0 0;">
                                ...
                                <div class="modal-body" style="padding: 30px;">
                                    <c:if test="${not empty sessionScope.changePasswordMess}">
                                        <div class="alert alert-${sessionScope.changePasswordMessType != null ? sessionScope.changePasswordMessType : 'info'} alert-dismissible fade show"
                                            role="alert">
                                    ...
                                    <p class="mb-4" style="color: #666;">
                                        ...
                                        Bạn đang sử dụng mật khẩu tạm. Vui lòng đổi mật khẩu thành mật khẩu mới theo yêu
                                        cầu của bạn.
                                    </p>
                                    ...
                                    <form action="changepassword" method="post" id="changePasswordForm">
                                        ...
                                        <div class="form-group mb-0">
                                            <button type="submit" class="btn btn-block" style="background: linear-gradient(135deg, #a366d1 0%, #9b59b6 100%); 
