...
public class LoadControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        // Nếu là admin, dùng EditProductContent.jsp trong admin dashboard layout
        if (a != null && a.getIsAdmin() == 1) {
            request.setAttribute("contentPage", "EditProductContent.jsp");
            request.getRequestDispatcher("AdminDashboardLayout.jsp").forward(request, response);
        } else {
            // Nếu không phải admin, dùng Edit.jsp standalone
