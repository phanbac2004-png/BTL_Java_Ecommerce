<%-- Document : Detail Created on : Dec 29, 2020, 5:43:04 PM Author : trinh --%>
            ...
            <%@page contentType="text/html" pageEncoding="UTF-8" %>
                ...
                <head>
                    ...
                    <style>
                        ...
                        .btn-buy-now {
                            background: linear-gradient(135deg, #ff6fae 0%, #EC407A 50%, #d81b60 100%);
                            color: #fff !important;
                            font-weight: 700;
                            border: none;
                            padding: 14px 34px;
                        ...
                        .btn-buy-now:hover {
                            ...
                            box-shadow: 0 10px 24px rgba(236, 64, 122, 0.45);
                        }
                ...
                <body>
                                                    ...
                                                    <div class="row align-items-center mb-2">
                                                        <div class="col-sm-7">
                                                            <label for="quantityInput"
                                                                style="font-weight:700;color:#AD1457;margin-bottom:6px;display:block;">Số
                                                                lượng</label>
                                                            <div class="quantity-picker"
                                                                aria-label="Chọn số lượng sản phẩm">
                                                                <button type="button" id="qtyMinus"
                                                                    aria-label="Giảm số lượng" tabindex="0">−</button>
                                                                <input type="number" id="quantityInput" name="quantity"
                                                                    value="1" min="1" max="${detail.quantity}"
                                                                    aria-live="polite" />
                                                                <button type="button" id="qtyPlus"
                                                                    aria-label="Tăng số lượng" tabindex="0">+</button>
                                                            </div>
                                                            <small id="stockInfo" class="text-muted d-block mt-2"
                                                                style="font-size:12px;">Tồn kho: <span
                                                                    id="stockCount">${detail.quantity}</span></small>
                                                        </div>
                                                    </div>
                                                    <hr>
                                                    <div class="product-actions">
                                                        <a href="#" id="buyNowBtn"
                                                            class="btn btn-buy-now text-uppercase">
                                                            <i class="fas fa-bolt mr-1"></i> Mua ngay
                                                        </a>
                                                        <button type="button" onclick="addToCart('${detail.id}')"
                                                            id="addToCartBtn"
                                                            class="btn btn-add-cart-solid text-uppercase">
                    ...
                    <div id="kiddyToast" class="kiddy-toast" role="alert" aria-live="polite" aria-atomic="true">
                        ...
                        <div class="kiddy-toast__content">
                            ...
                            <div class="kiddy-toast__message" id="kiddyToastMessage">Đã thêm vào giỏ hàng thành công!
                            </div>
