                                ...
                                <div class="card kid-card">
                                    ...
                                    <div class="card-body">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="form-check mb-3">
                                                            ...
                                                            <label class="form-check-label" for="cod">
                                                                <i class="fas fa-hand-holding-usd"></i> <strong>Thanh
                                                                    toán khi nhận hàng (COD)</strong>
                                                                <br><small class="text-muted">Bạn sẽ thanh toán khi nhận
                                                                    được hàng</small>
                                                            </label>
                                                        </div>
                                                        <div class="form-check">
                                                            ...
                                                            <label class="form-check-label" for="vnpay">
                                                                <i class="fas fa-credit-card"></i> <strong>Thanh toán
                                                                    bằng VNPay</strong>
                                                                <br><small class="text-muted">Thanh toán trực tuyến qua
                                                                    VNPay</small>
                                                            </label>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="card border-kid-pink">
                                            ...
                                            <div class="form-group">
                                                <button type="submit" class="btn btn-kid-cart btn-lg btn-block"
                                                    id="submitBtn">
                                                    <i class="fas fa-check"></i> <span id="btnText">Xác nhận đặt
                                                        hàng</span>
                                                </button>
                                            </div>
                                        </form>
                                        ...
                                        <table class="table table-sm">
                                                ...
                                                <c:forEach items="${list}" var="o">
                                                    <tr>
                                                        <td>
                                                            <c:choose>
                                                                <c:when
                                                                    test="${not empty o.product.image and (fn:startsWith(o.product.image,'/') or fn:startsWith(o.product.image,'http'))}">
                                                                    <c:set var="imgUrl" value="${o.product.image}" />
                                                                </c:when>
                                                                <c:otherwise>
                                                                    <c:set var="imgUrl"
                                                                        value="${pageContext.request.contextPath}/${o.product.image}" />
                                                                </c:otherwise>
                                                            </c:choose>
                                                                    ...
                                                                    <c:when test="${not empty o.variant}">
                                                                        <c:if test="${not empty o.variant.colorName}">
                                                                            <span class="variant-badge"
                                                                                title="Màu: ${o.variant.colorName}">${o.variant.colorName}</span>
                                                                        </c:if>
                                                                        <c:if test="${not empty o.variant.sizeName}">
                                                                            <span
                                                                                class="variant-badge variant-badge--muted"
                                                                                title="Size: ${o.variant.sizeName}">${o.variant.sizeName}</span>
                                                                        </c:if>
                                                                    </c:when>
                                                        ...
                                                        <td class="text-right">
                                                            <small>
                                                                <fmt:formatNumber value="${o.product.price * o.amount}"
                                            ...
                                            <tfoot>
                                                <tr>
                                                    ...
                                                    <td class="text-right text-pink-dark"><strong>
